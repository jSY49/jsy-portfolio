						...
						<div className={styles.about_info}>
							<div className={styles.about_summary}>
								...
								<p className={styles.about_summary_desc}>
									사용자의 불편을 줄이기 위해 노력하는 안드로이드 개발자입니다.{" "}
									<br />
									<br /> 아티스트별 상용 앱 17개를 직접 개발하였고, 이를 포함한
									48개 앱의 유지보수를 담당했습니다.
									<br />
									BLE 기반 디바이스 제어 앱을 공연장 내·외부에서 직접 테스트를
									진행하며, 실사용자 피드백을 반영해 오류 개선과 통신 안정화를
									이어왔습니다.
								</p>
							</div>
							...
							<div className={styles.about_item}>
								...
								<AboutInfo
									...
									onClick={() =>
										window.open("https://github.com/jSY49", "_blank")
									}
								/>
							</div>
						</div>
